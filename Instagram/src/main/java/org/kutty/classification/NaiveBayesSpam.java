...
public class NaiveBayesSpam {
	...
	/** 
	 * Given the array of posterior probabilities multiplies it with posterior probabilities
	 * @param probabilityArray Double array containing the posterior probabilities of the classes
	 */
