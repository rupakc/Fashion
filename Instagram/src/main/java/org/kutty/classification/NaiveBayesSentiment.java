...
public class NaiveBayesSentiment {
	...
	/** 
	 * Given the posterior probability array multiplies each entry with its prior probabilities
	 * @param probabilityArray Double array containing the values of the prior probability
	 */
